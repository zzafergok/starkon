        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Şu ana kadar tamamladığımız projelerin galeri görünümü. 
              Her projede modern teknolojiler ve yaratıcı çözümler kullandık.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Galerimizde gördüğünüz projeler gibi size özel çözümler geliştirmek için
