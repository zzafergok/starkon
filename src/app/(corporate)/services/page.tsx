        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Modern teknolojiler ile dijital çözümler sunuyoruz. Her projeye özel yaklaşımlarla 
              işletmenizin ihtiyaçlarına en uygun çözümleri geliştiriyoruz.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-xl text-blue-100 max-w-2xl mx-auto">
              Hangi hizmete ihtiyaç duyuyorsanız, uzman ekibimizle birlikte 
