          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className='mt-10 flex flex-col sm:flex-row gap-4'>
                <Button size='lg' className='px-8' onClick={() => (window.location.href = '/services')}>
                  Hizmetlerimiz
                  <ArrowRight className='ml-2 h-5 w-5' />
                </Button>
                <Button variant='outline' size='lg' className='px-8' onClick={() => (window.location.href = '/about')}>
                  Hakkımızda
                </Button>
              </div>
            </motion.div>
      ...
      <section className='py-16 bg-blue-600 dark:bg-blue-700'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <motion.div
            ...
            className='text-center'
          >
            <h2 className='text-3xl font-bold text-white sm:text-4xl'>Projenizi Başlatalım</h2>
            <p className='mt-6 text-xl text-blue-100 max-w-2xl mx-auto'>
              Fikirlerinizi hayata geçirmek için uzman ekibimizle iletişime geçin. Size özel çözümler geliştirerek
              hedeflerinize ulaşmanıza yardımcı olalım.
            </p>
